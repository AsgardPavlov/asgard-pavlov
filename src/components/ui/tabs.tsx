...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "data-[state=active]:bg-background data-[state=active]:text-white dark:data-[state=active]:text-black data-[state=active]:shadow data-[state=active]:bg-black dark:data-[state=active]:bg-neutral-100",
      "leading-5 p-0 rounded-full",
      className
    )}
    {...props}
  />
